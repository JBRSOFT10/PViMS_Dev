...
namespace PVIMS.Core.Services
{
    public interface IWorkFlowService
    {
        ...
        Task<ReportInstance> CreateWorkFlowInstanceAsync(string workFlowName, Guid contextGuid, string patientIdentifier, string sourceIdentifier,string gender, string organization, string reportingType, string facilityIdentifier);
