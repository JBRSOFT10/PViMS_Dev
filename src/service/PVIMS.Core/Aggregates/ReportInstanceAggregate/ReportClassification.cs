...
namespace PVIMS.Core.Aggregates.ReportInstanceAggregate
{
        ...
        : Enumeration
    {
        ...
        public static ReportClassification SERIOUS = new ReportClassification(1, "SERIOUS");
        public static ReportClassification NONSERIOUS = new ReportClassification(2, "NONSERIOUS");
        ...
        //    new[] { AESI, SAE
        //        , ClinicallySignificant, Unclassified
        //    };
        public static IEnumerable<ReportClassification> List() =>
        new[] {  NONSERIOUS ,SERIOUS
