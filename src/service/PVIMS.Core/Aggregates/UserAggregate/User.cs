...
namespace PVIMS.Core.Aggregates.UserAggregate
{
    public class User : EntityBase
	{
        ...
        public virtual ICollection<Dashboard> DashboardCreations { get; set; }
        public virtual ICollection<Dashboard> DashboardUpdates { get; set; }
        public virtual ICollection<DashboardElement> DashboardElementCreations { get; set; }
        public virtual ICollection<DashboardElement> DashboardElementUpdates { get; set; }
        public virtual ICollection<DashboardSeries> DashboardSeriesCreations { get; set; }
        public virtual ICollection<DashboardSeries> DashboardSeriesUpdates { get; set; }
        public virtual ICollection<DashboardVisualisation> DashboardVisualisationCreations { get; set; }
        public virtual ICollection<DashboardVisualisation> DashboardVisualisationUpdates { get; set; }
