...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ConceptAggregate.Concept", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ConceptAggregate.ConceptIngredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ConceptAggregate.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ContactAggregate.SiteContactDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.Dashboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardElement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DashboardElement", (string)null);
                });

            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DashboardElementId")
                        .HasColumnType("int");

                    b.Property<int>("DashboardUnitId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastUpdated")
                        .HasColumnType("datetime2");

                    b.Property<string>("ListSQL")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("DashboardElementId");

                    b.HasIndex("UpdatedById");

                    b.ToTable("DashboardSeries", (string)null);
                });

            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardVisualisation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DashboardVisualisation", (string)null);
                });

            modelBuilder.Entity("PVIMS.Core.Aggregates.DatasetAggregate.Dataset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DatasetAggregate.DatasetInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.UserAggregate.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.UserAggregate.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.UserAggregate.UserFacility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ConceptAggregate.ConceptIngredient", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.ConceptAggregate.Concept", "Concept")
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ContactAggregate.SiteContactDetail", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "CreatedBy")
                        .WithMany("SiteContactDetailCreations")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "UpdatedBy")
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.Dashboard", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "CreatedBy")
                        .WithMany("DashboardCreations")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "UpdatedBy")
                        .WithMany("DashboardUpdates")
                        .HasForeignKey("UpdatedById");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardElement", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "CreatedBy")
                        .WithMany("DashboardElementCreations")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVIMS.Core.Aggregates.DashboardAggregate.Dashboard", null)
                        .WithMany("Elements")
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "UpdatedBy")
                        .WithMany("DashboardElementUpdates")
                        .HasForeignKey("UpdatedById");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardSeries", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "CreatedBy")
                        .WithMany("DashboardSeriesCreations")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVIMS.Core.Aggregates.DashboardAggregate.DashboardElement", null)
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "UpdatedBy")
                        .WithMany("DashboardSeriesUpdates")
                        .HasForeignKey("UpdatedById");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardVisualisation", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "CreatedBy")
                        .WithMany("DashboardVisualisationCreations")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVIMS.Core.Aggregates.DashboardAggregate.DashboardElement", null)
                        .WithMany("VisualisationElements")
                        .HasForeignKey("DashboardElementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "UpdatedBy")
                        .WithMany("DashboardVisualisationUpdates")
                        .HasForeignKey("UpdatedById");
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DatasetAggregate.DatasetInstance", b =>
                {
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.DatasetAggregate.Dataset", "Dataset")
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.NotificationAggregate.Notification", b =>
                {
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "DestinationUser")
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.ReportInstanceAggregate.ActivityExecutionStatusEvent", b =>
                {
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "EventCreatedBy")
                        .WithMany("ExecutionEvents")
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.UserAggregate.RefreshToken", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "User")
            ...
            modelBuilder.Entity("PVIMS.Core.Entities.Appointment", b =>
                {
                    b.HasOne("PVIMS.Core.Aggregates.UserAggregate.User", "AuditUser")
                    ...
                    b.HasOne("PVIMS.Core.Entities.Patient", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("PVIMS.Core.Entities.ConditionMedication", b =>
                {
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.ConceptAggregate.Product", "Product")
                        .WithMany("ConditionMedications")
            ...
            modelBuilder.Entity("PVIMS.Core.Entities.DatasetInstanceValue", b =>
                {
                    ...
                    b.HasOne("PVIMS.Core.Aggregates.DatasetAggregate.DatasetInstance", "DatasetInstance")
                        .WithMany("DatasetInstanceValues")
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.DashboardAggregate.DashboardElement", b =>
                {
                    ...
                    b.Navigation("VisualisationElements");
                });
            ...
            modelBuilder.Entity("PVIMS.Core.Aggregates.UserAggregate.User", b =>
                {
                    ...
                    b.Navigation("DashboardCreations");

                    b.Navigation("DashboardElementCreations");

                    b.Navigation("DashboardElementUpdates");

                    b.Navigation("DashboardSeriesCreations");

                    b.Navigation("DashboardSeriesUpdates");

                    b.Navigation("DashboardUpdates");

                    b.Navigation("DashboardVisualisationCreations");

                    b.Navigation("DashboardVisualisationUpdates");
