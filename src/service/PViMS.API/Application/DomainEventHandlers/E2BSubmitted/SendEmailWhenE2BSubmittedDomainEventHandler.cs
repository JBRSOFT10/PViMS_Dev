...
namespace PVIMS.API.Application.DomainEventHandlers.E2BSubmitted
{
                            ...
                            : INotificationHandler<E2BSubmittedDomainEvent>
    {
        ...
        public async Task Handle(E2BSubmittedDomainEvent domainEvent, CancellationToken cancellationToken)
        {
            ...
            sb.Append("<table>");
            sb.Append($"<tr><td style='padding: 10px; border: 1px solid black;'><b>Terminology</b></td><td style='padding: 10px; border: 1px solid black;'>Test</td></tr>");//{domainEvent.ReportInstance.TerminologyMedDra.DisplayName}
        ...
        private async Task<List<MailboxAddress>> PrepareDestinationMailBoxesAsync(E2BSubmittedDomainEvent domainEvent)
        {
