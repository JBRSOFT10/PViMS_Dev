...
export class DatasetService extends BaseService {
  ...
  getDatasets(filterModel: any): any {
    ...
    return this.Get<DatasetDetailWrapperModel>(
      '/datasets',
  ...
  getDatasetCategories(datasetid: number, filterModel: any): any {
    ...
    return this.Get<DatasetCategoryDetailWrapperModel>(
  ...
  getDatasetCategoryElements(
    ...
    return this.Get<DatasetCategoryElementDetailWrapperModel>(
      `/datasets/${datasetid}/categories/${datasetCategoryId}/elements`,
      'application/vnd.pvims.detail.v1+json',
      parameters
    );
  }
  ...
  getDatasetInstanceDetail(datasetid: number, id: number): any {
    ...
    return this.Get<DatasetInstanceDetailWrapperModel>(
  ...
  getDataset(id: number): any {
    ...
    return this.Get<DatasetCategoryIdentifierModel>(
      `/datasets`,
  ...
  getSpontaneousDataset(): any {
    ...
    return this.Get<DatasetCategoryIdentifierModel>(
      `/datasets`,
      'application/vnd.pvims.spontaneousdataset.v1+json',
      parameters
    );
  }
  ...
  saveDatasetCategoryElement(
    ...
    if (id == 0) {
      ...
      return this.Put(
        `datasets/${datasetid}/categories/${datasetCategoryId}/elements/${id}`,
        model
      );
    }
  }
  ...
  downloadSummary(workFlowGuid: string, reportInstanceId: number): any {
    ...
    return this.Download(
      `/datasets/workflow/${workFlowGuid}/reportinstances`,
  ...
  loadDivisions(): any {
    ...
    return this.Get(
      `/datasets/get-division`,
      'application/vnd.pvims.identifier.v1+json',
      parameters
    );
  }

  loadDistrict(divisionId: string): any {
    let parameters: ParameterKeyValueModel[] = [];

    return this.Get(
      `/datasets/get-district?diviion_id=${divisionId}`,
      'application/vnd.pvims.identifier.v1+json',
      parameters
    );
  }

  loadThana(districtId: string): any {
    let parameters: ParameterKeyValueModel[] = [];

    return this.Get(
      `/datasets/get-thana?district_id=${districtId}`,
      'application/vnd.pvims.identifier.v1+json',
      parameters
    );
  }
